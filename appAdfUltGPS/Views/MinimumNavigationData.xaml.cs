...
namespace appAdfUltGPS.Views
{
    ...
    /// </summary>
    public sealed partial class MinimumNavigationDataPage : Page
    {
        // Instantiate the View Model
        public MinimumNavigationPageViewModel MinimumNavigationPageViewModel { get; set; } = new MinimumNavigationPageViewModel();
        // Default Constructor
        public MinimumNavigationDataPage()
        {
        ...
        {
            MinimumNavigationPageViewModel?.CleanUpViewModel();
        }
